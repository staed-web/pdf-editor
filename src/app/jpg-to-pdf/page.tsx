  ...
  return (
    <MarketingShell>
      <ToolShell tool={tool} options={
        ...
        <DropZone accept="image/jpeg,.jpg,.jpeg" multiple onFiles={(fs)=>{ const imgs=fs.filter(isImageFile); if(!imgs.length) return toast.error("Images only"); addFiles(imgs); setResult(null); }} label="Drop JPG images" />
