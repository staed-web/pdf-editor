  ...
  return (
    <MarketingShell>
      <ToolShell tool={tool} options={
        ...
        <DropZone accept="image/png,.png" multiple onFiles={(fs)=>{ const imgs=fs.filter(isImageFile); if(!imgs.length) return toast.error("Images only"); addFiles(imgs); setResult(null); }} label="Drop PNG images" />
